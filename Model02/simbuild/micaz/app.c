...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2afd6e6d5cf8, const void *arg_0x2afd6e6d4020);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x2afd6e755618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2afd6e9978e8), 
int (*key_eq_fn)(void *arg_0x2afd6e9960c8, void *arg_0x2afd6e996368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2afd6eba7610, int arg_0x2afd6eba7878);
static double RandomUniform(void );
...
typedef TMilli FloodingPartC$TimerSink$precision_tag;
typedef uint16_t FloodingPartC$Seed$parameter;
typedef TMilli FloodingPartC$RandomTimer$precision_tag;
...
static void FloodingPartC$Boot$booted(void );
# 113 "/usr/src/tinyos/tos/interfaces/SplitControl.nc"
static void FloodingPartC$RadioControl$startDone(error_t error);
#line 138
static void FloodingPartC$RadioControl$stopDone(error_t error);
# 83 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
static void FloodingPartC$TimerSink$fired(void );
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static void FloodingPartC$RadioAMSend$sendDone(
#line 103
message_t * msg, 
...
uint8_t len);
# 83 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
static void FloodingPartC$RandomTimer$fired(void );
# 75 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
static void FloodingPartC$broadcastSink$runTask(void );
#line 75
static void FloodingPartC$broadcastNode$runTask(void );
...
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static error_t /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 64 "/usr/src/tinyos/tos/interfaces/ParameterInit.nc"
...
# 104 "/usr/src/tinyos/tos/interfaces/SplitControl.nc"
static error_t FloodingPartC$RadioControl$start(void );
...
FloodingPartC$RadioPacket$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 46 "/usr/src/tinyos/tos/interfaces/Random.nc"
static uint32_t FloodingPartC$Random$rand32(void );
# 64 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
static void FloodingPartC$TimerSink$startPeriodic(uint32_t dt);
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static error_t FloodingPartC$RadioAMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 64 "/usr/src/tinyos/tos/interfaces/ParameterInit.nc"
static error_t FloodingPartC$Seed$init(FloodingPartC$Seed$parameter param);
# 73 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
static void FloodingPartC$RandomTimer$startOneShot(uint32_t dt);




static void FloodingPartC$RandomTimer$stop(void );
# 67 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
static error_t FloodingPartC$broadcastSink$postTask(void );
#line 67
static error_t FloodingPartC$broadcastNode$postTask(void );
# 88 "/usr/src/tinyos/tos/interfaces/AMPacket.nc"
static am_addr_t FloodingPartC$AMPacket$source(
#line 84
message_t * amsg);
#line 78
static am_addr_t FloodingPartC$AMPacket$destination(
#line 74
message_t * amsg);
#line 147
static am_id_t FloodingPartC$AMPacket$type(
#line 143
message_t * amsg);
# 33 "FloodingPartC.nc"
enum FloodingPartC$__nesc_unnamed4332 {
#line 33
  FloodingPartC$broadcastSink = 3U
};
#line 33
typedef int FloodingPartC$__nesc_sillytask_broadcastSink[FloodingPartC$broadcastSink];
enum FloodingPartC$__nesc_unnamed4333 {
#line 34
  FloodingPartC$broadcastNode = 4U
};
#line 34
typedef int FloodingPartC$__nesc_sillytask_broadcastNode[FloodingPartC$broadcastNode];
#line 23
message_t FloodingPartC$packet[1000];
my_msg_t *FloodingPartC$recv_msg[1000];
uint8_t FloodingPartC$counter[1000];

bool FloodingPartC$recv_pack[1000][255];
bool FloodingPartC$timer_pack[1000][255];
uint32_t FloodingPartC$randomTimer[1000];
nx_uint8_t FloodingPartC$temp_id[1000];
nx_uint8_t FloodingPartC$temp_payload[1000][2];




int FloodingPartC$sinkCounter[1000];



static inline void FloodingPartC$Boot$booted(void );
#line 54
static inline void FloodingPartC$RadioControl$startDone(error_t err);
#line 74
static inline void FloodingPartC$RadioControl$stopDone(error_t arg_0x2afd6f19adf8);




static inline void FloodingPartC$TimerSink$fired(void );
...
static void FloodingPartC$RadioAMSend$sendDone(message_t *buf, error_t err);
...
static inline message_t *FloodingPartC$Receive$receive(message_t *buf, void *payload, uint8_t len);
#line 162
static inline void FloodingPartC$RandomTimer$fired(void );
...
static inline void FloodingPartC$broadcastSink$runTask(void );
#line 193
static inline void FloodingPartC$broadcastNode$runTask(void );
# 53 "/usr/src/tinyos/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
static void /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/usr/src/tinyos/tos/interfaces/Send.nc"
static error_t /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
...
inline static void FloodingPartC$RandomTimer$stop(void ){
#line 78
...
# 73 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void FloodingPartC$RandomTimer$startOneShot(uint32_t dt){
#line 73
...
# 46 "/usr/src/tinyos/tos/interfaces/Random.nc"
inline static uint32_t FloodingPartC$Random$rand32(void ){
#line 46
  unsigned int __nesc_result;
#line 46
...
#line 46
# 88 "/usr/src/tinyos/tos/interfaces/AMPacket.nc"
inline static am_addr_t FloodingPartC$AMPacket$source(message_t * amsg){
#line 88
  unsigned short __nesc_result;
#line 88
...
#line 97
{
  ...
  if (TOS_NODE_ID == 0) {
      sim_log_debug(156U, "recv", "\n");
      sim_log_debug(157U, "recv", "Packet received by SINK. \n");
      sim_log_debug(158U, "recv", "DROPPING THE PACKET... \n");
    }
  else {
      sim_log_debug(159U, "recv", "\n");
      sim_log_debug(160U, "recv", "I'm node %d and I've received a packet from Node %d \n", TOS_NODE_ID, FloodingPartC$AMPacket$source(buf));
      sim_log_debug(161U, "recv", "\t Time of reception: %s \n", sim_time_string());


      FloodingPartC$recv_msg[sim_node()] = (my_msg_t *)payload;



      sim_log_debug(162U, "recv", "\t The ID of the message is: %d \n", __nesc_ntoh_uint16(FloodingPartC$recv_msg[sim_node()]->msg_id.nxdata));

      sim_log_debug(163U, "recv", "RECV FROM %d PACKET %hhu \n", TOS_NODE_ID, __nesc_ntoh_uint16(FloodingPartC$recv_msg[sim_node()]->msg_id.nxdata));

      sim_log_debug(164U, "recv", "\t The payload of the packet is: %s \n", FloodingPartC$recv_msg[sim_node()]->payload);

      if (!FloodingPartC$timer_pack[sim_node()][__nesc_ntoh_uint16(FloodingPartC$recv_msg[sim_node()]->msg_id.nxdata)]) {

          if (!FloodingPartC$recv_pack[sim_node()][__nesc_ntoh_uint16(FloodingPartC$recv_msg[sim_node()]->msg_id.nxdata)]) {
              FloodingPartC$recv_pack[sim_node()][__nesc_ntoh_uint16(FloodingPartC$recv_msg[sim_node()]->msg_id.nxdata)] = TRUE;
              sim_log_debug(165U, "recv", "\t I've set as TRUE the boolean of packet: %d \n", __nesc_ntoh_uint16(FloodingPartC$recv_msg[sim_node()]->msg_id.nxdata));
              sim_log_debug(166U, "recv", "\t SETTING RANDOM TIMER FOR REFORWARDING... \n");

              __nesc_hton_uint8(FloodingPartC$temp_id[sim_node()].nxdata, __nesc_ntoh_uint16(FloodingPartC$recv_msg[sim_node()]->msg_id.nxdata));

              memcpy(FloodingPartC$temp_payload[sim_node()], FloodingPartC$recv_msg[sim_node()]->payload, sizeof(nx_uint8_t ) * 2);





              FloodingPartC$randomTimer[sim_node()] = FloodingPartC$Random$rand32() % 5000;
              if (FloodingPartC$randomTimer[sim_node()] < 1000) {
                  FloodingPartC$randomTimer[sim_node()] = FloodingPartC$randomTimer[sim_node()] + 1234;
                }


              sim_log_debug(167U, "recv", "The random timer is %d \n", FloodingPartC$randomTimer[sim_node()]);
              FloodingPartC$RandomTimer$startOneShot(FloodingPartC$randomTimer[sim_node()]);
              FloodingPartC$timer_pack[sim_node()][__nesc_ntoh_uint16(FloodingPartC$recv_msg[sim_node()]->msg_id.nxdata)] = TRUE;
            }
          else {
              sim_log_debug(168U, "recv", "\t I've already received the packet with ID: %d \n", __nesc_ntoh_uint16(FloodingPartC$recv_msg[sim_node()]->msg_id.nxdata));
            }
        }
      else {
          sim_log_debug(169U, "recv", "I've received a packet for which the random timer is running \n");
          sim_log_debug(170U, "recv", "STOPPING THE RANDOM TIMER.... \n");
          __nesc_hton_uint8(FloodingPartC$temp_id[sim_node()].nxdata, __nesc_ntoh_uint16(FloodingPartC$recv_msg[sim_node()]->msg_id.nxdata));
          FloodingPartC$RandomTimer$stop();
        }
    }
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2afd6ef9a340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2afd6ef9a340) {
#line 78
    case 6:
#line 78
      __nesc_result = FloodingPartC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2afd6ef9a340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/usr/src/tinyos/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2afd6ef99020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2afd6ef99020, msg, payload, len);
#line 78
...
# 104 "/usr/src/tinyos/tos/interfaces/SplitControl.nc"
inline static error_t FloodingPartC$RadioControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
# 64 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void FloodingPartC$TimerSink$startPeriodic(uint32_t dt){
#line 64
...
#line 54
{
  if (err == SUCCESS) {
      if (TOS_NODE_ID == 0) {
          ...
          sim_log_debug(148U, "boot", "I'm the SINK node with id %d and my RADIO is ON \n", TOS_NODE_ID);
          FloodingPartC$TimerSink$startPeriodic(10000);
        }
      else {
          sim_log_debug(149U, "boot", "I'm a NODE with id %d and my RADIO is ON \n", TOS_NODE_ID);
        }
    }
  else {
      sim_log_debug(150U, "boot", "I'm NODE %d and I have to start again my RADIO", TOS_NODE_ID);
      FloodingPartC$RadioControl$start();
    }
}
...
#line 113
  FloodingPartC$RadioControl$startDone(error);
#line 113
}
#line 113
# 96 "/usr/src/tinyos/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  FloodingPartC$RadioControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2afd6ef9c220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2afd6ef9c220, msg, error);
#line 110
}
#line 110
...
inline static am_id_t FloodingPartC$AMPacket$type(message_t * amsg){
#line 147
  unsigned char __nesc_result;
#line 147
...
#line 147
#line 78
inline static am_addr_t FloodingPartC$AMPacket$destination(message_t * amsg){
#line 78
  unsigned short __nesc_result;
#line 78
...
#line 78
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static error_t FloodingPartC$RadioAMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/usr/src/tinyos/tos/interfaces/Packet.nc"
inline static void * FloodingPartC$RadioPacket$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
# 171 "FloodingPartC.nc"
static inline void FloodingPartC$broadcastSink$runTask(void )
#line 171
{
  my_msg_t *msg = (my_msg_t *)FloodingPartC$RadioPacket$getPayload(&FloodingPartC$packet[sim_node()], sizeof(my_msg_t ));

#line 173
  __nesc_hton_uint16(msg->msg_id.nxdata, FloodingPartC$counter[sim_node()]++);

  strcpy(msg->payload, "abc");
  sim_log_debug(174U, "sink", "SENT FROM %d \n", TOS_NODE_ID);
  sim_log_debug(175U, "sink", "Random INT is %d for Packet ID %d \n", msg->payload, __nesc_ntoh_uint16(msg->msg_id.nxdata));

  sim_log_debug(176U, "sink", "Try to send a BROADCAST PACKET at time %s \n", sim_time_string());
  if (FloodingPartC$RadioAMSend$send(AM_BROADCAST_ADDR, &FloodingPartC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(177U, "radio_pack", "\t Packet dimension: %hhu \n", sizeof(my_msg_t ));
      sim_log_debug(178U, "radio_pack", "\t Source: %hhu \n", FloodingPartC$AMPacket$source(&FloodingPartC$packet[sim_node()]));
      sim_log_debug(179U, "rasdio_pack", "\t Destination: %hhu \n", FloodingPartC$AMPacket$destination(&FloodingPartC$packet[sim_node()]));
      sim_log_debug(180U, "radio_pack", "\t Packet Type: %hhu \n", FloodingPartC$AMPacket$type(&FloodingPartC$packet[sim_node()]));

      sim_log_debug(181U, "radio_pack", "\t Message ID: %d \n", __nesc_ntoh_uint16(msg->msg_id.nxdata));
      sim_log_debug(182U, "radio_pack", "\t Payload: %s \n", msg->payload);
    }
}
...
#line 195
  __nesc_hton_uint16(msg->msg_id.nxdata, __nesc_ntoh_uint8(FloodingPartC$temp_id[sim_node()].nxdata));

  memcpy(msg->payload, FloodingPartC$temp_payload[sim_node()], sizeof(nx_uint8_t ) * 2);

  sim_log_debug(183U, "forw", "\n");
  sim_log_debug(184U, "forw", "SENT FROM %d \n", TOS_NODE_ID);
  sim_log_debug(185U, "forw", "I'm node %d. Trying to REFORWARD a BROADCAST PACKET at time %s \n", TOS_NODE_ID, sim_time_string());
  if (FloodingPartC$RadioAMSend$send(AM_BROADCAST_ADDR, &FloodingPartC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(186U, "radio_pack", "\t Packet dimension: %hhu \n", sizeof(my_msg_t ));
      sim_log_debug(187U, "radio_pack", "\t Source: %hhu \n", FloodingPartC$AMPacket$source(&FloodingPartC$packet[sim_node()]));
      sim_log_debug(188U, "radio_pack", "\t Destination: %hhu \n", FloodingPartC$AMPacket$destination(&FloodingPartC$packet[sim_node()]));
      sim_log_debug(189U, "radio_pack", "\t Packet Type: %hhu \n", FloodingPartC$AMPacket$type(&FloodingPartC$packet[sim_node()]));

      sim_log_debug(190U, "radio_pack", "\t Message ID: %d \n", __nesc_ntoh_uint16(msg->msg_id.nxdata));
      sim_log_debug(191U, "radio_pack", "\t Payload: %s \n", msg->payload);
    }
}
...
# 110 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static void /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  FloodingPartC$RadioAMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/usr/src/tinyos/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2afd6f4aae18, message_t * msg, error_t error){
#line 100
  switch (arg_0x2afd6f4aae18) {
#line 100
    case 0U:
#line 100
      /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2afd6f4aae18, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2afd6eca8020){
#line 75
  switch (arg_0x2afd6eca8020) {
#line 75
...
#line 75
      break;
#line 75
    case FloodingPartC$broadcastSink:
#line 75
      FloodingPartC$broadcastSink$runTask();
#line 75
      break;
#line 75
    case FloodingPartC$broadcastNode:
#line 75
      FloodingPartC$broadcastNode$runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2afd6eca8020);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/usr/src/tinyos/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2afd6f4a7020, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2afd6f4a7020, addr, msg, len);
#line 80
...
# 67 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static error_t FloodingPartC$broadcastSink$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(FloodingPartC$broadcastSink);
#line 67
...
#line 79
{
  FloodingPartC$sinkCounter[sim_node()]++;
  sim_log_debug(151U, "sink", "\n");
  sim_log_debug(152U, "sink", "COUNTER: %d \n", FloodingPartC$sinkCounter[sim_node()]);
  sim_log_debug(153U, "sink", "@@@@@@@@@@@@@@@@@@ NEW PACKET FROM SINK EACH 60s  @@@@@@@@@@@@@@@@@@@@@@@@\n");
  sim_log_debug(154U, "sink", "I'm the SINK and I post a task for sending a broadcast packet \n");
  FloodingPartC$broadcastSink$postTask();
}

# 67 "/usr/src/tinyos/tos/interfaces/TaskBasic.nc"
inline static error_t FloodingPartC$broadcastNode$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(FloodingPartC$broadcastNode);
#line 67
...
#line 67
# 162 "FloodingPartC.nc"
static inline void FloodingPartC$RandomTimer$fired(void )
#line 162
{
  sim_log_debug(171U, "timer", "\n");
  sim_log_debug(172U, "timer", "I'm node %d and my RANDOM timer has expired. \n", TOS_NODE_ID);
  sim_log_debug(173U, "timer", "Proceeding with a REFORWARDING... \n");
  FloodingPartC$broadcastNode$postTask();
...
# 83 "/usr/src/tinyos/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2afd6f43dc28){
#line 83
  switch (arg_0x2afd6f43dc28) {
#line 83
    case 0U:
#line 83
      FloodingPartC$TimerSink$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      FloodingPartC$RandomTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2afd6f43dc28);
#line 83
      break;
#line 83
    }
...
# 103 "/usr/src/tinyos/tos/interfaces/AMPacket.nc"
inline static void /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 75 "/usr/src/tinyos/tos/interfaces/Send.nc"
inline static error_t /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 62
# 62 "/usr/src/tinyos/tos/system/RandomMlcgC.nc"
static inline error_t RandomMlcgC$SeedInit$init(uint16_t s)
#line 62
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 64 "/usr/src/tinyos/tos/interfaces/ParameterInit.nc"
inline static error_t FloodingPartC$Seed$init(FloodingPartC$Seed$parameter param){
#line 64
  unsigned char __nesc_result;
#line 64
...
#line 44
  ...
  FloodingPartC$Seed$init(seed + TOS_NODE_ID + 1);
...
#line 90
{
  if (&FloodingPartC$packet[sim_node()] == buf && err == SUCCESS) {
      sim_log_debug(155U, "Packet sent done at time %s \n", sim_time_string());
    }
}
...
#line 55
{
  /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*FloodingPartAppC.RadioAM.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module FloodingPartC */
  if (!strcmp(varname, "FloodingPartC$packet"))
  {
    *addr = (uintptr_t)&FloodingPartC$packet[__nesc_mote];
    *size = sizeof(FloodingPartC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FloodingPartC$recv_msg"))
  {
    *addr = (uintptr_t)&FloodingPartC$recv_msg[__nesc_mote];
    *size = sizeof(FloodingPartC$recv_msg[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FloodingPartC$counter"))
  {
    *addr = (uintptr_t)&FloodingPartC$counter[__nesc_mote];
    *size = sizeof(FloodingPartC$counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FloodingPartC$recv_pack"))
  {
    *addr = (uintptr_t)&FloodingPartC$recv_pack[__nesc_mote];
    *size = sizeof(FloodingPartC$recv_pack[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FloodingPartC$timer_pack"))
  {
    *addr = (uintptr_t)&FloodingPartC$timer_pack[__nesc_mote];
    *size = sizeof(FloodingPartC$timer_pack[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FloodingPartC$randomTimer"))
  {
    *addr = (uintptr_t)&FloodingPartC$randomTimer[__nesc_mote];
    *size = sizeof(FloodingPartC$randomTimer[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FloodingPartC$temp_id"))
  {
    *addr = (uintptr_t)&FloodingPartC$temp_id[__nesc_mote];
    *size = sizeof(FloodingPartC$temp_id[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FloodingPartC$temp_payload"))
  {
    *addr = (uintptr_t)&FloodingPartC$temp_payload[__nesc_mote];
    *size = sizeof(FloodingPartC$temp_payload[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FloodingPartC$sinkCounter"))
  {
    *addr = (uintptr_t)&FloodingPartC$sinkCounter[__nesc_mote];
    *size = sizeof(FloodingPartC$sinkCounter[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module FloodingPartC */
  memset((void *)&FloodingPartC$packet[__nesc_mote], 0, sizeof FloodingPartC$packet[__nesc_mote]);
  memset((void *)&FloodingPartC$recv_msg[__nesc_mote], 0, sizeof FloodingPartC$recv_msg[__nesc_mote]);
  FloodingPartC$counter[__nesc_mote] = 0;
  memset((void *)&FloodingPartC$recv_pack[__nesc_mote], 0, sizeof FloodingPartC$recv_pack[__nesc_mote]);
  memset((void *)&FloodingPartC$timer_pack[__nesc_mote], 0, sizeof FloodingPartC$timer_pack[__nesc_mote]);
  FloodingPartC$randomTimer[__nesc_mote] = 0;
  memset((void *)&FloodingPartC$temp_id[__nesc_mote], 0, sizeof FloodingPartC$temp_id[__nesc_mote]);
  memset((void *)&FloodingPartC$temp_payload[__nesc_mote], 0, sizeof FloodingPartC$temp_payload[__nesc_mote]);
  FloodingPartC$sinkCounter[__nesc_mote] = 0;
